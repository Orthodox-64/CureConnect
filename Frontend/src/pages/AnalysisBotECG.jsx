...
const formatAnalysisResults = (text) => {
    ...
    return lines.map(line => {
        ...
        if (cleanLine.match(/^(Heart Rhythm|Heart Rate|Wave Analysis|Normal Findings|Abnormal Findings|Clinical Significance|Recommendations|Confidence Score|Emergency Level|Image Quality)/i)) {
            return {
                type: 'header',
                content: cleanLine
            };
...
function AnalysisBotECG() {
    ...
    // Analyze the uploaded ECG image using Gemini AI
    const analyzeImage = async (imageUrl) => {
        ...
        try {
            ...
            // Create the prompt for ECG analysis
            const prompt = `You are an expert cardiologist specializing in ECG (Electrocardiogram) analysis. Analyze the provided ECG image with the following structure:
Heart Rhythm: Identify the rhythm pattern (normal sinus rhythm, arrhythmia, atrial fibrillation, etc.)
Heart Rate: Calculate approximate heart rate from the ECG tracing
Wave Analysis: Detailed examination of:
- P wave morphology and rhythm
- QRS complex width and morphology
- T wave changes and abnormalities
- PR and QT intervals assessment
Normal Findings: List any normal cardiac electrical activity patterns observed
...
- Any other ECG abnormalities
Clinical Significance: Explain the clinical implications of the findings
Recommendations: Provide specific medical recommendations and follow-up suggestions
...
'Emergency Level: 2' (moderate concerns - prompt medical attention needed)
...
Please format your response with clear section headers followed by detailed content. Avoid using asterisks or markdown formatting.`;
            ...
            setAnalysis("Error processing the ECG image. Please try again.");
        } finally {
    ...
    const simplifyAnalysis = async (medicalAnalysis) => {
        try {
            ...
            Please convert this ECG analysis into simple terms that someone without a medical background can understand.
                    ...
                    <div className="bg-gray-50 rounded-xl p-6">
                        <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center">
                                ...
                                <h2 className="text-xl font-semibold text-gray-700 ml-2">ECG Analysis Results</h2>
                            </div>
                            {analysis && (
                        ...
                        {isAnalyzing ? (
                            <div className="flex flex-col items-center py-10">
                                ...
                                <p className="text-gray-600">Processing your ECG...</p>
                            </div>
                        ) : analysis ? (
                            ...
                            <div className="flex flex-col items-center py-10">
                                ...
                                <p className="text-gray-500">Upload an ECG image to receive analysis</p>
                            </div>
                        )}
                    </div>
                </div>
