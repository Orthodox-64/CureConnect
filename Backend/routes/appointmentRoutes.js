...
const { newAppointment, allAppointments, deleteAppointment, getSingleAppointment, getAvailableSlots, markAppointmentComplete } = require('../controller/appointmentController');
